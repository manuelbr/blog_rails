...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { article_id: @comentario.article_id, body: @comentario.body, user_id: @comentario.user_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { article_id: @comentario.article_id, body: @comentario.body, user_id: @comentario.user_id } }
